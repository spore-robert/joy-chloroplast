...
#define joy_home
#ifdef joy_home
const char* ssid = "分科倒數";
const char* password = "Joy94824";//home ap password
const char* mqtt_server = "172.20.10.11";//mac in home ip
#else
...
void reconnect() {
  ...
  while (!client.connected()) {
    ...
    if (client.connect(clientId.c_str())) {
      ...
      client.subscribe("node_red/alcohol/cmd");//????
    } else {
...
void swSerialRead()
{
  ...
  if(s != "")
  {
    ...
    client.publish("esp8266/alcohol/respond", msg);//????
  }
